...
The `-p` argument allows the user to see more or fewer plots by choosing between the parameters `b`, `i`, and `a` representing basic, intermediate, and all, respectively.  The `b` parameter
